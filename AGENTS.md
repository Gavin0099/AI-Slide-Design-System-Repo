...
- Any breaking change to the Semantic Slide Model.
- Adding a second renderer or changing output ownership between generated and hand-authored files.
- CI, publishing, or release changes that can expose generated decks outside the repository.
