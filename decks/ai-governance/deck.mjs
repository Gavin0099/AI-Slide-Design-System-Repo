  ...
  "slides": [
    ...
    },
    {
      ...
      "steps": [
        ...
        {
          "title": "選擇版型",
          "detail": "只使用允許的語意 layout"
        },
        {
          "title": "產生證據",
          "detail": "Build、截圖與人工審查"
        }
      ]
    },
    {
      ...
      "layers": [
        {
          "title": "AI 決策層",
          "detail": "決定訊息、版型與需要呈現的證據"
        },
        {
          "title": "Semantic Model",
          "detail": "限制欄位、內容密度與允許的版型"
        },
        {
          "title": "Renderer + Theme",
          "detail": "把模型轉成可重現的 Slidev 與 editable PPTX"
        }
      ]
    },
    {
