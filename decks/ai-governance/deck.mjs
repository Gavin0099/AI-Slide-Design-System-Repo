  ...
  slides: [
    ...
    },
    {
      ...
      layers: [
        ...
        { title: 'Renderer + Theme', detail: '把模型轉成可重現的 Slidev 與 editable PPTX' },
      ],
    },
    {
      type: 'evidence',
    ...
    },
    {
      ...
      title: '用少數指標呈現品質狀態',
      metrics: [
        { label: '語意版型', value: '10', detail: '全部進入 allowlist' },
        { label: '視覺基準', value: '10/10', detail: '固定尺寸並完成審查' },
        { label: '像素差異', value: '0.000%', detail: '同環境 regression' },
      ],
    },
    {
      type: 'decision',
      ...
      nextAction: '驗證 editable PPTX 的可編輯性、版面與跨平台字型邊界。',
    },
    {
      type: 'closing',
      ...
      actions: ['以十種 layout 建立正式 deck', '在 CI 驗證固定字型資產', '交付 editable PPTX renderer'],
      nextAction: '下一階段：蒐集跨平台 PPTX 與像素輸出證據。',
    },
  ],
})
