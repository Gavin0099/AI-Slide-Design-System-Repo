...
目前證明的是 pinned font asset、semantic model、十個 layout、renderer、lint、Slidev build，以及單一 Windows/Chrome 環境下的 screenshot baseline 與人工視覺審查。它不證明跨作業系統像素一致性、PDF/PPTX 匯出品質或 editable PPTX renderer 已完成。
